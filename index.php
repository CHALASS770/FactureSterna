            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="src/assets/images/profile/yves.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
          ...
          <div class="d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Mes factures et Devis</h5>
                <div class="table-responsive">
                  <table id="invoices_table"  data-search="true" data-pagination="true" data-sortable="true">
                    <thead>
                      <tr>
                        <th data-field="invoice_number">Numero</th>
                        <th data-field="type">Type</th>
                        <th data-field="customer_name">Client</th>
                        <th data-field="total">Montant</th>
                        <th data-field="updated_at">Date</th>
